/* PROBLEM CODE HERE*/
//var playerShrooms = localStorage.getItem('playerShrooms') || Math.floor(Math.random() * 50000000) + 20000000;
var playerShrooms = /*prompt("How many gumpshrooms would you like to start with?",*/Math.floor(Math.random() * 50000000) + 20000000/*).replace(/\D/g, '')*/;
//PROBLEM CODE??
...
function logBet() {
  if (playerShrooms >= document.getElementById("playerBet").value) {
    var bet = {
      amount: 0,
      player: "",
      taken: false,
      won: false,
      timer: (Math.random() * 20000) + 50
    };
...
function betTaken(betamount) {
  ...
  if (flip() == true) {
    ...
    $(document).ready(function () {
      ...
      $.notify(generateName() + " took your " + numberWithCommas(betamount) + " gumpshroom bet, and you won, \n earning you " + numberWithCommas(betamount * 2) + " gumpshrooms.", {
        className: "success",
        globalPosition: 'top center'
      }
      );
    });
    playerShrooms = playerShrooms + betamount * 2;
    ...
    node.removeChild(document.getElementById(betamount));
    $(document).ready(function () {
      $.notify(generateName() + " took your " + numberWithCommas(betamount) + " gumpshroom bet, and you lost. \n Better luck next time.", {
        className: "error",
        globalPosition: "top center"
      }
      );
  ...
  function postNewBets() {
    ...
    for (i = 0; i < Math.floor(Math.random() * 10) + 1; i++) {
      ...
      bet.amount = Math.floor(Math.random() * 75000000) + 1000;
      bet.player = generateName();
      ...
      if (flip() == true) {
        ...
        $(document).ready(function () {
          ...
          $.notify("You bet " + numberWithCommas(betamount) + " gumpshrooms. \n \n" +
            ...
            "MEANINGLESS " + "\n \n" +
            "You gain " + numberWithCommas(betamount * 2) + " gumpshrooms.", {
              className: "success",
              globalPosition: 'top center'
            }
          );
        ...
        console.log(betamount);
        console.log(playerShrooms);
        playerShrooms = playerShrooms + parseInt(betamount);
        console.log(betamount);
        console.log(playerShrooms);
        //localStorage.setItem('playerShrooms', playerShrooms);
        update();
